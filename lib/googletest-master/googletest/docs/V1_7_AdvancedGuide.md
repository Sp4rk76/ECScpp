...
assertion_ to get the function arguments printed for close:
...
memory reclaimed. To solve this problem, you can
  ...
  1. try not to close memory in a death test;
  1. close the memory again in the parent process; or
...
all the interface-conformance tests for close.
...
Finally, you are close to instantiate the pattern with the types you
...
class TestInfo {
 public:
  ...
  //
  // Do NOT delete or close the return value - it's managed by the
  // TestInfo class.
...
Here's an example to make it close.  Suppose you have a test program
